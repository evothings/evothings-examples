...
app.resetting = false;
app.resetTimeout = false;
app.scanTimeout = false;
app.connectTimeout = false;
...
app.startMag = function(device)
{
	...
	ble.enableNotification(
		device,
		window.sessionStorage.getItem('magData'),
		function(data)
	{
...
app.write = function(writeFunc, device, name, value)
{
...
app.checkServices = function(device)
{
